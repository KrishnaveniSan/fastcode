...
public class DefaultTemplateContentAssistant extends AbstractTemplateContentAssistant {
	...
	public DefaultTemplateContentAssistant(final Map<FIRST_TEMPLATE, SECOND_TEMPLATE> properties, final boolean propertiesOnly) {
