...
public class FastCodeTemplateViewerConfiguration extends SourceViewerConfiguration {
	 ...
	 */
	public FastCodeTemplateViewerConfiguration(final ITokenScanner tokenScanner, final ITokenScanner fcTagTokenScanner,
			final ITextHover textHover, final IAutoEditStrategy[] autoEditStrategies, final IContentAssistProcessor assistProcessor,
	...
	public String[] getConfiguredContentTypes(final ISourceViewer sourceViewer) {
		return new String[] { IDocument.DEFAULT_CONTENT_TYPE, FastCodeTemplatePartitions.SINGLE_LINE_COMMENT,
				FastCodeTemplatePartitions.MULTI_LINE_COMMENT, FastCodeTemplatePartitions.FC_METHOD, FastCodeTemplatePartitions.FC_FIELD,
				FastCodeTemplatePartitions.FC_CLASS, FastCodeTemplatePartitions.FC_FILE, FastCodeTemplatePartitions.FC_PACKAGE,
				FastCodeTemplatePartitions.FC_FOLDER, FastCodeTemplatePartitions.FC_PROJECT, FastCodeTemplatePartitions.FC_MESSAGE,
				FastCodeTemplatePartitions.FC_EXIT, FastCodeTemplatePartitions.FC_IMPORT, FastCodeTemplatePartitions.FC_XML,
				FastCodeTemplatePartitions.FC_CLASSES, FastCodeTemplatePartitions.FC_FILES, FastCodeTemplatePartitions.FC_PROPERTY,
